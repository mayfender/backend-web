...
CREATE TABLE spt_import_finger_det ( finger_det_id int NOT NULL AUTO_INCREMENT, finger_id varchar(10), date_stamp date, time_stamp time, action char(1), finger_file_id int, PRIMARY KEY (finger_det_id) ) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE spt_registration ( reg_id int NOT NULL AUTO_INCREMENT, member_id varchar(30), empire_no varchar(10), firstname varchar(150), lastname varchar(150), citizen_id varchar(13), birthday date, finger_id varchar(50), img_id int, user_id int, member_type_id int, register_date date, expire_date date, con_tel_no varchar(50), con_mobile_no1 varchar(50), con_line_id varchar(50), con_facebook varchar(50), con_email varchar(100), con_address varchar(200), status tinyint, created_by int, modified_by int, prefix_name_id int, con_mobile_no2 varchar(50), con_mobile_no3 varchar(50), firstname_eng varchar(150), lastname_eng varchar(150), pay_type tinyint, price double, zipcode_id int, PRIMARY KEY (reg_id) ) ENGINE=InnoDB DEFAULT CHARSET=utf8;
CREATE TABLE spt_receipt ( receipt_id int NOT NULL AUTO_INCREMENT, receipt_no varchar(20), receipt_type tinyint, created_date_time datetime, updated_date_time datetime, ref_id int, PRIMARY KEY (receipt_id) ) ENGINE=InnoDB DEFAULT CHARSET=utf8;
CREATE TABLE spt_member_renewal ( renewal_id int NOT NULL AUTO_INCREMENT, member_id varchar(30), member_type_id int, register_date date, expire_date date, status tinyint, is_active tinyint(1), created_by int, created_date_time datetime, updated_by int, updated_date_time datetime, reg_id int, pay_type tinyint, price double, PRIMARY KEY (renewal_id) ) ENGINE=InnoDB DEFAULT CHARSET=utf8;
