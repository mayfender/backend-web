...
CREATE TABLE order_menu ( id int NOT NULL AUTO_INCREMENT, menu_id int NOT NULL, cus_id int NOT NULL, created_date_time datetime, updated_date_time datetime, changed_status_date_time datetime, status tinyint NOT NULL, amount tinyint NOT NULL, comment varchar(256), order_round tinyint, is_take_home tinyint(1) NOT NULL, is_cancel tinyint(1) NOT NULL, cancel_reason varchar(256), PRIMARY KEY (id) ) ENGINE=InnoDB DEFAULT CHARSET=utf8;
