...
insert into roles (id, username, authority, name) values (1, 'root', 'ROLE_ROOT', 'Root');
DROP TABLE users;
...
insert into users (id, username_show, username, password, enabled, created_date_time, updated_date_time) values (1, 'Root', 'root', '$2a$10$mNHt9RDl.3/ifSOCU44EWeP7lIeMqHy.mYObhX4DRBayPiNvpJU16', 1, now(), now());
