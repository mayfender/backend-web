...
insert into users (id, username, password, enabled, created_date_time, updated_date_time) values (1, 'may', 'may', '$2a$10$mNHt9RDl.3/ifSOCU44EWeP7lIeMqHy.mYObhX4DRBayPiNvpJU16', 1, now(), now());
insert into users (id, username, password, enabled, created_date_time, updated_date_time) values (2, 'ple', 'ple', '$2a$10$mNHt9RDl.3/ifSOCU44EWeP7lIeMqHy.mYObhX4DRBayPiNvpJU16', 1, now(), now());
