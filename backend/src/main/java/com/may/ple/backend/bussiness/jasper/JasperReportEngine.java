...
public class JasperReportEngine {
	...
	private JasperPrint process(String jasperFile, List<Map> obj, Map<String, Object> parameters) throws Exception {
		try {
			...
			JasperPrint jasperPrint = JasperFillManager.fillReport(jasperFile, parameters, beanColDataSource);
			return jasperPrint;
	...
	public byte[] toPdf(String jasperFile, List<Map> obj, Map<String, Object> parameters) throws Exception {
		try {
			
			JasperPrint jasperPrint = process(jasperFile, obj, parameters);
	...
	public String toPdfFile(String jasperFile, List<Map> obj, Map<String, Object> parameters) throws Exception {
		try {
