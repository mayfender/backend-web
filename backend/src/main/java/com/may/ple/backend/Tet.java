...
import com.may.ple.backend.pdf.BaseReportBuilder;
import com.may.ple.backend.pdf.ReceiptRegistration;

public class Tet extends BaseReportBuilder {
	private static final Logger LOG = Logger.getLogger(ReceiptRegistration.class.getName());
	private String DEST = "C:/Users/mayfender/Desktop/may_2.pdf";
...
//		file.getParentFile().mkdirs();
		...
		try {
			new ReceiptRegistration().createPdf();			
		} catch (Exception e) {
