...
public class SptRegistration implements Serializable {
	...
	private Integer sentMailStatus;
	@ManyToOne
	...
	public SptRegistration(String memberId, String empireNo, SptMasterNamingDet prefixName, String firstname, String lastname, String firstnameEng, String lastnameEng, String citizenId,
			...
			Integer status, Long createdBy, Long modifiedBy, Long memberTypeId, Long userId, Long imgId, Integer payType, Double price, Zipcodes zipcode, Integer sentMailStatus) {
		this.memberId = memberId;
	...
	public Integer getSentMailStatus() {
		return sentMailStatus;
	}
	public void setSentMailStatus(Integer sentMailStatus) {
		this.sentMailStatus = sentMailStatus;
	}
