...
import com.may.ple.backend.action.DownloadFileAction;
import com.may.ple.backend.action.MasterNamingAction;
import com.may.ple.backend.action.PdfRenderAction;
...
public class JerseyConfig extends ResourceConfig {
	...
	public JerseyConfig() {
		...
		register(PdfRenderAction.class);
		register(DownloadFileAction.class);
		...
		register(SptImportFingerDetAction.class);
	}
