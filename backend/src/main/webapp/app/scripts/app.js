...
var app = angular
  ...
  .config(['$stateProvider','$urlRouterProvider','$ocLazyLoadProvider', '$httpProvider', '$translateProvider', 'cfpLoadingBarProvider', 'tagsInputConfigProvider',
    ...
    .state('dashboard.fieldsSetting.list',{
    	templateUrl:'views/fields_setting/list.html',
    	url:'/fieldsSetting/list',
    	controller: 'FieldsSettingListCtrl',
    	resolve: {
            loadMyFiles:function($ocLazyLoad) {
              return $ocLazyLoad.load({
            	  name:'sbAdminApp',
                  files:['scripts/controllers/fields_setting/listCtrl.js']
              });
            },
            loadData:function($rootScope, $stateParams, $http, $state, $filter, $q, $localStorage, urlPrefix) {
...
//            	return deferred.promise;
    ...
    .state('dashboard.plugin',{
    	templateUrl:'views/plugin/main.html',
    	url:'/plugin',
    	params: {'currentPage': 1, 'itemsPerPage': 10},
    	...
    	resolve: {
            loadMyFiles:function($ocLazyLoad) {
              return $ocLazyLoad.load({
            	  name:'sbAdminApp',
                  files:['scripts/controllers/plugin/pluginCtrl.js']
              });
            },
            loadData:function($rootScope, $stateParams, $http, $state, $filter, $q, $localStorage, urlPrefix) {
