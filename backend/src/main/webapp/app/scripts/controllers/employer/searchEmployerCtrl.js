angular.module('sbAdminApp').controller('SearchEmployerCtrl', function($rootScope, $scope, $http, $state, $translate, loadUsers, urlPrefix, roles) {	
	...
	$translate('employer.header.panel.search').then(function (userList) {
