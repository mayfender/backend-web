angular.module('sbAdminApp').controller('DeployerFileCtrl', function($rootScope, $scope, $state, $base64, $http, $localStorage, $translate, FileUploader, urlPrefix, loadData) {
	...
	uploader = $scope.uploader = new FileUploader({
        url: urlPrefix + '/restAct/program/uploadDeployer', 
