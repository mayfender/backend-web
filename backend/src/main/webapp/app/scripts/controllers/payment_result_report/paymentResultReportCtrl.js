angular.module('sbAdminApp').controller('PaymentResultReportCtrl', function($rootScope, $scope, $state, $base64, $http, $localStorage, $translate, FileUploader, urlPrefix, loadData) {
	...
	$scope.search = function() {
		$http.post(urlPrefix + '/restAct/paymentReport/find', {
	...
	$scope.download = function(id) {
		$http.post(urlPrefix + '/restAct/paymentReport/download', {
			id: id,
			productId: $rootScope.workingOnProduct.id
	...
	$scope.deleteItem = function(id) {
		...
		$http.post(urlPrefix + '/restAct/paymentReport/deleteFile', {
			id: id,
			currentPage: $scope.formData.currentPage, 
			itemsPerPage: $scope.formData.itemsPerPage,
			productId: $rootScope.workingOnProduct.id
